...
public class RecommendAttractionClass {
    String spotAddress;
    String spotname;
    String spotpic;
    String spotid;
    ...
    public RecommendAttractionClass(String spotAddress,String spotname,String spotpic,String spotid,Double dis,String binhour
...
//    public RecommendAttractionClass(String spotAddress,String spotname,String spotpic,String spotid,Double dis,String binhour
//            ,String tel, String spotlong, String spotlat,String country) {
...
//    }
    ...
    public static Comparator<RecommendAttractionClass> bydis2=new Comparator<RecommendAttractionClass>() {
        @Override
        public int compare(RecommendAttractionClass one, RecommendAttractionClass two) {
            return -Double.valueOf(one.getDis()).compareTo(Double.valueOf(two.getDis()));
        }
    };

    public static Comparator<RecommendAttractionClass> byhota37=new Comparator<RecommendAttractionClass>() {
        @Override
        public int compare(RecommendAttractionClass one, RecommendAttractionClass two) {
            return -one.getall37().compareTo(two.getall37());
        }
    };
    public static Comparator<RecommendAttractionClass> byhota55=new Comparator<RecommendAttractionClass>() {
        @Override
        public int compare(RecommendAttractionClass one, RecommendAttractionClass two) {
    ...
    public static Comparator<RecommendAttractionClass> byhota73=new Comparator<RecommendAttractionClass>() {
        @Override
        public int compare(RecommendAttractionClass one, RecommendAttractionClass two) {
    ...
    public static Comparator<RecommendAttractionClass> byhotm37=new Comparator<RecommendAttractionClass>() {
        @Override
        public int compare(RecommendAttractionClass one, RecommendAttractionClass two) {
    ...
    public static Comparator<RecommendAttractionClass> byhotm55=new Comparator<RecommendAttractionClass>() {
        @Override
        public int compare(RecommendAttractionClass one, RecommendAttractionClass two) {
    ...
    public static Comparator<RecommendAttractionClass> byhotm73=new Comparator<RecommendAttractionClass>() {
        @Override
        public int compare(RecommendAttractionClass one, RecommendAttractionClass two) {
