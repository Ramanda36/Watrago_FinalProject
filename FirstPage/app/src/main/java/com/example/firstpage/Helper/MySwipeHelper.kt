package com.example.firstpage.Helper
...
abstract class MySwipeHelper(context : Context, private val recyclerView :RecyclerView,
    ...
    private val onTouchListener = View.OnTouchListener{_,motionEvent->
        ...
        val swipeViewHelper = recyclerView.findViewHolderForAdapterPosition(swipePosition)
        val swipeItem = swipeViewHelper!!.itemView
        val rect = Rect()
