...
import com.example.firstpage.TransportFragment.public_travel_adapter
...
class public_travel : AppCompatActivity(){
    ...
    internal lateinit var adapter: public_travel_adapter
    ...
    private fun loadDataFromFirebase() {
        ...
        db.collection("Schedule")
            .orderBy("LikeCount", Query.Direction.DESCENDING).get()
            .addOnCompleteListener { task ->
                for (querySnapshot in task.result!!) {
                    var publicTravel= querySnapshot.getString("privacy")
                    if(publicTravel=="False"){
                    ...
                    adapter= public_travel_adapter(this@public_travel, travelArraylist)
